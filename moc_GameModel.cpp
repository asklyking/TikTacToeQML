...
QT_MOC_LITERAL(1, 10, 23), // "isListObjectMenuChanged"
QT_MOC_LITERAL(2, 34, 0) // ""

    },
    "GameModel\0isListObjectMenuChanged\0"
};
...
void GameModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->isListObjectMenuChanged(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameModel::isListObjectMenuChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameModel::isListObjectMenuChanged()
{
