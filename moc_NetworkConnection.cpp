...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_NetworkConnection_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_NetworkConnection_t qt_meta_stringdata_NetworkConnection = {
    {
QT_MOC_LITERAL(0, 0, 17), // "NetworkConnection"
QT_MOC_LITERAL(1, 18, 23), // "isCurrentMessageChanged"
QT_MOC_LITERAL(2, 42, 0), // ""
QT_MOC_LITERAL(3, 43, 14) // "receiveMessage"

    },
    "NetworkConnection\0isCurrentMessageChanged\0"
    "\0receiveMessage"
};
...
void NetworkConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->isCurrentMessageChanged(); break;
        ...
        {
            typedef void (NetworkConnection::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetworkConnection::isCurrentMessageChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject NetworkConnection::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_NetworkConnection.data,
      qt_meta_data_NetworkConnection,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *NetworkConnection::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NetworkConnection.stringdata0))
...
// SIGNAL 0
void NetworkConnection::isCurrentMessageChanged()
{
